...
export class AddExpressionContext extends ParserRuleContext {
	public ADD(): TerminalNode { return this.getToken(TodoLangGrammarParser.ADD, 0); }
	public TODO(): TerminalNode { return this.getToken(TodoLangGrammarParser.TODO, 0); }
	public STRING(): TerminalNode { return this.getToken(TodoLangGrammarParser.STRING, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return TodoLangGrammarParser.RULE_addExpression; }
	// @Override
	public enterRule(listener: TodoLangGrammarListener): void {
...
export class CompleteExpressionContext extends ParserRuleContext {
	public COMPLETE(): TerminalNode { return this.getToken(TodoLangGrammarParser.COMPLETE, 0); }
	public TODO(): TerminalNode { return this.getToken(TodoLangGrammarParser.TODO, 0); }
	public STRING(): TerminalNode { return this.getToken(TodoLangGrammarParser.STRING, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return TodoLangGrammarParser.RULE_completeExpression; }
	// @Override
	public enterRule(listener: TodoLangGrammarListener): void {
